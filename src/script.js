...
const tick = () => {
  ...
  const parallaxFactor = deltaTime * 5;
  cameraGroup.position.x += parallaxX - cameraGroup.position.x * parallaxFactor;
  cameraGroup.position.y += parallaxY - cameraGroup.position.y * parallaxFactor;
